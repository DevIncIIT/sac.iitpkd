<script lang="ts">
	...
	const expenses = [
		{name:'food', amount : 200, index:0},
		{name:'judges', amount : 200, index:1},
		{name:'professors', amount : 200, index:2},
		{name:'travel', amount : 200, index:3},
		{name:'supplies', amount : 2000, index:4},
		{name:'merch', amount : 200, index:5},
	...
	const councils = [
        ...
        {name: 'Technical Council', budget: 10000, spent: 100000 },
...
<div class = 'dashboard grid md:grid-cols-2 gap-6 p-6'>
	...
	<div class = 'p-6'>
		...
		<div class="council-card border rounded-lg">
            <div class="flex justify-between items-center">
                <h2 class = "section-title">Garba celebration</h2>
                <button class="text-sm font-semibold text-gray-700 bg-gray-200 rounded-[20%] px-4 py-2"> Statistics</button>
            </div>
    ...
    <!-- left bottom part -->
        <div class="council-card p-6 border rounded-lg space-y-4">
                ...
                <div class="flex justify-between items-center p-3">
                    ...
                    <div class="h-full rounded-full transition-all duration-300"
                        style="width: {Math.min(100, (expense.amount / total_expense) * 100)}%; 
                                background-color: {['#dd3cdd','#4CAF50', '#2196F3', '#FF9800', '#9C27B0', '#FFC107'][expense.index % 6]};">
                    </div>
                </div>
            {/each}
    ...
    <div class="p-6">
        ...
        <div class="council-card p-4 border rounded-lg space-y-4">
            ...
            <div class="flex justify-between items-center">
                ...
                <p class="text-gray-500">{((council.spent / council.budget) * 100).toFixed(0)}%</p>
            </div>
